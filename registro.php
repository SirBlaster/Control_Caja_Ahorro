...
<body>
    ...
    <div class="card card-form container mt-4 p-4 shadow-sm" style="max-width: 800px;">
        ...
        <form action="./includes/procesar_registro.php" method="POST">
            ...
            <div class="row g-3 mb-3">
                <div class="col-md-6">
                    <input type="email" name="correo_personal" class="form-control" placeholder="Correo personal"
                        required>
                </div>
                <div class="col-md-6">
                    <input type="text" name="telefono" class="form-control" placeholder="Número celular (10 dígitos)"
            ...
            <div class="row g-3 mb-3">
                ...
                <div class="col-12">
                    <small class="d-flex align-items-center p-2 bg-light border rounded"
                        style="color:#d18819; font-weight:500;">
            ...
            <div class="row g-3 mt-2">
                ...
                <div class="col-md-12 text-center mt-4">
                    <button type="submit" class="btn btn-primary btn-lg w-50"
                        style="background-color: #d18819; border: none;">REGISTRARME</button>
                </div>
